...
//create action creator , make writing easier reducer , mutates states inside reducer
...
const accountSlice = createSlice({
    ...
    reducers : {
        ...
        // to get more than 1 arg in payload
        requestLoan :{
...
export function deposit(amount , currency) {
    ...
    // return function means this is async function executed after dispatch and before reducer updation
